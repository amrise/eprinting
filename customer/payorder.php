<?php
  ...
  require ('../database/updateprofile.php'); 
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 bg-gradient-info">
              <h6 class="m-0 font-weight-bold text-gray-100">Your Payment</h6>
            </div>
            <div class="card-body">

                <form action="../payment.php?id=<?php echo $custid1 ?>" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            if( $colour1  == 1)
                            {
                              echo '<input type="text" class="form-control" value="Black and White" disabled>';
                            } else
                            {
                              echo '<input type="text" class="form-control" value="Colour" disabled>';
                            }  
                            ?>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            if( $binding1  == 1)
                            {
                              echo '<input type="text" class="form-control" value="Binding Comb" disabled>';
                            } else
                            {
                              echo '<input type="text" class="form-control" value="Binding Tape" disabled>';
                            }  
                            ?>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          ...
                          if( $transparent1  == 1)
                          {
                            echo '<input type="text" class="form-control" value="Front and Back" disabled>';
                          } else if( $transparent1  == 2)
                          {
                            echo '<input type="text" class="form-control" value="Front only" disabled>';
                          } else
                          {
                            echo '<input type="text" class="form-control" value="Did not use" disabled>';
                          }  
                          ?>
                        </div>
                      </div>
