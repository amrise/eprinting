<?php
  require ('../database/newcustorder.php');
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <?php
                         ...
                         { echo ' 
                          <div class="form-check">
                            <input class="form-check-input" id="radio1" type="radio" value="1" name="warna"  checked>
                            <label class="form-check-label" for="radio1">Black and White</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" id="radio2" type="radio" value="2" name="warna">
                         ...
                         { echo ' 
                          <div class="form-check">
                            <input class="form-check-input" id="radio1" type="radio" value="1" name="warna">
                            <label class="form-check-label" for="radio1">Black and White</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" id="radio2" type="radio" value="2" name="warna" checked>
                            <label class="form-check-label" for="radio2">Colour</label>
                          </div>
                          ';
                         } 
                      ...
                      <div class="form-group row">
                        ...
                        { echo ' 
                        <div class="form-check">
                          <input class="form-check-input" id="radio1" type="radio" value="1" name="binding" checked>
                          <label class="form-check-label" for="radio1">Binding Comb</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" id="radio2" type="radio" value="2" name="binding">
                        ...
                        { echo ' 
                          <div class="form-check">
                            <input class="form-check-input" id="radio1" type="radio" value="1" name="binding">
                            <label class="form-check-label" for="radio1">Binding Comb</label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" id="radio2" type="radio" value="2" name="binding" checked>
                            <label class="form-check-label" for="radio2">Binding Tape</label>
                          </div>
                           ';
                          }
                      ...
                      <div class="form-group row">
                        ...
                        { echo ' 
                        <div class="form-check">
                          <input class="form-check-input" id="radio1" type="radio" value="1" name="transparent" checked>
                          <label class="form-check-label" for="radio1">Front and Back</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" id="radio2" type="radio" value="2" name="transparent">
                          <label class="form-check-label" for="radio2">Front only</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" id="radio3" type="radio" value="3" name="transparent">
                          <label class="form-check-label" for="radio3">Did not need</label>
                        </div>
                         ';
                        } else if($transparent2 == 2)
                        { echo ' 
                        <div class="form-check">
                          <input class="form-check-input" id="radio1" type="radio" value="1" name="transparent">
                          <label class="form-check-label" for="radio1">Front and Back</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" id="radio2" type="radio" value="2" name="transparent" checked>
                          <label class="form-check-label" for="radio2">Front only</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" id="radio3" type="radio" value="3" name="transparent">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" id="radio3" type="radio" value="3" name="transparent" checked>
                          <label class="form-check-label" for="radio3">Did not need</label>
                        </div>
                         ';
                        }
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="amount" value="<?php echo $amount2; ?> " min="1">
                        </div>
                      </div>
