...
<html lang="en">
	<head>
		...
		<!-- Bootstrap core CSS -->
		<link href="cssNantes/bootstrap.min.css" rel="stylesheet">
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
		<!-- Custom styles for this template -->
		<link href="cssNantes/owl.carousel.css" rel="stylesheet">
		<link href="cssNantes/owl.theme.default.min.css"  rel="stylesheet">
		<link href="cssNantes/animate.css" rel="stylesheet">
		<link href="cssNantes/style.css" rel="stylesheet">
	</head>
	<body id="page-top">
		<!-- Navigation -->
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="#page-top"><img src="imagesNantes/logo.png" alt="Sanza theme logo"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="#partners">Login</a>
						</li>
						<li>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<h2>About</h2>
							<p>UTeM e-Printing enable the customer in printing their task with easy, fast and everywhere they go. <br><strong>Just create your account. Make a your first transaction and you are on a right away!!</strong></p>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-3 text-center">
						<div class="mz-module">
							<div class="mz-module-about">
								<h3>Binding Comb</h3>
								<p><strong>RM 1.00</strong> per comb.</p><br>
								<h3>Binding Tape</h3>
								<p><strong>RM 0.50</strong> per tape.</p>
							</div>
						</div>
					</div>
					<!-- end about module -->
					...
					<div class="col-md-3 text-center">
						<div class="mz-module">
							<div class="mz-module-about">
								<h3>Transparent Cover</h3>
								<p><strong>RM 0.50</strong> per item.</p>
							</div>
						</div>
					</div>
					<!-- end about module -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<h2>Contact Us</h2>
							<p>If you have some Questions or need Help! Please Contact Us!<br>We respond you as soon as possible.</p>
						</div>
					</div>
				</div>
				<div class="row">
		...
		<footer>
			<div class="container text-center">
				<p>Copyright &copy; E-Printing Syamsul Amri Bin Jamaludin B031710093</p>
			</div>
		</footer>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="imagesNantes/demo/portfolio-1.jpg" alt="img01" class="img-responsive" />
		...
		<div class="modal fade" id="Modal-2" tabindex="-1" role="dialog" aria-labelledby="Modal-label-2">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="imagesNantes/demo/portfolio-2.jpg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-3" tabindex="-1" role="dialog" aria-labelledby="Modal-label-3">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="imagesNantes/demo/portfolio-3.jpg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-4" tabindex="-1" role="dialog" aria-labelledby="Modal-label-4">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="imagesNantes/demo/portfolio-4.jpg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="Modal-5" tabindex="-1" role="dialog" aria-labelledby="Modal-label-5">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<img src="imagesNantes/demo/portfolio-5.jpg" alt="img01" class="img-responsive" />
						<div class="modal-works"><span>Branding</span><span>Web Design</span></div>
						<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe</p>
					</div>
					<div class="modal-footer">
		...
		<script src="jsNantes/bootstrap.min.js"></script>
		<script src="jsNantes/owl.carousel.min.js"></script>
		<script src="jsNantes/cbpAnimatedHeader.js"></script>
		<script src="jsNantes/jquery.appear.js"></script>
		<script src="jsNantes/SmoothScroll.min.js"></script>
		<script src="jsNantes/theme-scripts.js"></script>
	</body>
</html>